    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        />
                  ...
                  {/* Real candidate links — generated by the backend's
             /api/cases/{caseId}/share-link and
             /api/cases/{caseId}/checks/{checkKey}/share-link routes as
             url("/candidate-verification?token={token}"). Public,
             token-gated inside the wizard itself (see bg.jsx), so no
