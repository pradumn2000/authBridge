...
export default function VerificationForm() {
  ...
  const [uploadedFile, setUploadedFile] = useState({
    ...
    status: 'Verified',
    ocrData: [
      { label: 'Employer Name', value: 'Tech Solutions Ltd' },
      { label: 'Designation', value: 'Frontend Developer' }
    ]
  });
  ...
  const handleFileUpload = (empIdx, docIdx, file) => {
    if (!file) return;
    const updated = [...employers];
    if (!updated[empIdx].documents) {
      updated[empIdx].documents = [];
    }
  ...
  const addEmployer = () => {
    setEmployers([...employers, { doe: '', documents: [] }]);
  };
      ...
      {isModalOpen && (
        <div style={styles.modalOverlay}>
          <div style={styles.modalCard}>
            ...
            {/* STEP 1 TO 3 PLACEHOLDERS / RENDER LOGIC */}
            {currentStep < 4 && (
              <div>
                <span style={styles.stepBadge}>Step {currentStep} of 7</span>
                <h2 style={styles.stepHeaderTitle}>Step {currentStep} Details</h2>
                <div style={styles.footer}>
                  {currentStep > 1 && (
            ...
            {/* STEP 4: EMPLOYMENT DETAILS & DOCUMENTS */}
            {currentStep === 4 && (
              <div>
                <span style={styles.stepBadge}>Step 4 of 7</span>
                <h2 style={styles.stepHeaderTitle}>Employment Details</h2>
                <p style={styles.subtitle}>Provide details about your previous work experience and relevant documents.</p>
                        ...
                        <div style={styles.docGrid}>
                          {[1, 2, 3, 4].map((docNum, dIdx) => (
                            <div key={dIdx} style={styles.docBox}>
                              ...
                              {emp.documents && emp.documents[dIdx] && (
