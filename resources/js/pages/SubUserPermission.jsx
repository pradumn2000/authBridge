...
const SubUserPermission = () => {
  const initialModules = [
    { id: 1, title: "Identity Verification", subtitle: "PAN, Aadhaar, DL and other identity checks", icon: <IconBadge />, iconBg: "bg-blue-600", permissions: { view: true, edit: false, download: true, approve: false } },
